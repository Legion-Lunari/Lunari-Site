...
export const questions: QuizQuestion[] = [
  {
    ...
    opciones: [
      ...
      { texto: 'Cómo siempre tiene una respuesta ocurrente.', puntos: { jano: 1 } },
  ...
  },
  {
    ...
    opciones: [
      ...
      { texto: 'Le muestras la manera de cómo continuar.', puntos: { febe: 1 } },
    ],
  },
  {
  ...
  {
    pregunta: 'Si caminaras por un bosque bajo la luna, ¿qué guiaría tus pasos?',
    opciones: [
